function lm35(min, max) {
    ...
    max = typeof max == 'undefined' ? 34 : max;
...
function dht11(options){
    ...
    if (minHumidity < 15 || maxHumidity > 100) {
    ...
    minTemperature = typeof minTemperature == 'undefined' ? 19 : minTemperature;
    maxTemperature = typeof maxTemperature == 'undefined' ? 34 : maxTemperature;

    minHumidity = typeof minHumidity == 'undefined' ? 19 : minHumidity;
